...
def end_state_supercell_calc_setup(
    ...
    if not os.path.exists(vasp_calc_dir):
        ...
        os.system("cp %s %s" % (potcar_path, vasp_calc_dir + "/POTCAR"))
        os.system("cp %s %s" % (incar_template, vasp_calc_dir + "/INCAR"))
        os.system("cp %s %s" % (kpoints_template, vasp_calc_dir + "/KPOINTS"))
