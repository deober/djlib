...
def mc_run_creator(run_params: dict, run_dir: str, style="grand_canonical"):
    """
    ...
    style: str
        The style of monte carlo simulation to run.
        Options: grand_canonical, LTE
